...
<div style="margin-left:15%;padding:1px 16px;height:1000px;">
    <div class="container-pic" style="float: right">
      ...
      <div class="centered">Manage My Posts ❀ </div><br>
         <a href="add_posts.php" class="btn-secondary"></i>Add new post</a>
        </div>
  ...
  <div class="box">
            ...
            <a href="edit_posts.php?id=<?php echo $id; ?>" class="btn-secondary">Update Posts</a>
            <a href="delete_posts.php?id=<?php echo $id; ?>" class="btn-secondary">Delete Posts</a>
  </div>
